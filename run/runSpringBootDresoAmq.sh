...
--SPRING_ACTIVEMQ_EXPORT_PML_PROFILE_DESTINATION=$SPRING_ACTIVEMQ_EXPORT_OPPORTUNITY_DESTINATION \
--SPRING_ACTIVEMQ_EXPORT_PML_RELATION_DESTINATION=$SPRING_ACTIVEMQ_EXPORT_OPPORTUNITY_DESTINATION \
--SPRING_ACTIVEMQ_EXPORT_ELEMENT_DESTINATION=$SPRING_ACTIVEMQ_EXPORT_OPPORTUNITY_DESTINATION \
--SPRING_ACTIVEMQ_EXPORT_FUNCTION_DESTINATION=$SPRING_ACTIVEMQ_EXPORT_OPPORTUNITY_DESTINATION \
--SPRING_ACTIVEMQ_EXPORT_PML_SPECIALFUNCTION_DESTINATION=$SPRING_ACTIVEMQ_EXPORT_OPPORTUNITY_DESTINATION \
--SPRING_ACTIVEMQ_EXPORT_PML_FUNCTION_STRUCTURE_DESTINATION=$SPRING_ACTIVEMQ_EXPORT_OPPORTUNITY_DESTINATION \
--SPRING_ACTIVEMQ_EXPORT_PML_MEMBER_DESTINATION=$SPRING_ACTIVEMQ_EXPORT_OPPORTUNITY_DESTINATION \
