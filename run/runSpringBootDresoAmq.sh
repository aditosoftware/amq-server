...
--SPRING_ACTIVEMQ_EXPORT_PML_ELEMENT_DESTINATION=$SPRING_ACTIVEMQ_EXPORT_ELEMENT_DESTINATION \
--SPRING_ACTIVEMQ_EXPORT_PML_FUNCTION_DESTINATION=$SPRING_ACTIVEMQ_EXPORT_FUNCTION_DESTINATION \
